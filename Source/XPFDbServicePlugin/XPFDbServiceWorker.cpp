...
bool XPFDbServiceWorker::exec(const QString& sql, SqlResult** result) {
...
bool XPFDbServiceWorker::insert(const QString& tb_name, const QVariantMap& valueMap, SqlResult** result) {
