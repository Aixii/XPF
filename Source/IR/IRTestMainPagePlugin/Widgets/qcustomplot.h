...
public:
  ...
  void setYThreshold(double min, double max){mYThresholdMin = min; mYThresholdMax = max;}
...
protected:
  ...
  virtual void drawPolyline(QCPPainter *painter, const QVector<QPointF> &lineData) const;
...
public:
  ...
  */
  ...
  void setSmooth(bool value){ mSmooth = value;}
